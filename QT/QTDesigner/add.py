...
class Ui_Dialog_add(object):
    ...
    def setupUi(self, QDialog):
        ...
        self.cancelButton.setGeometry(QtCore.QRect(230, 120, 81, 32))
        self.cancelButton.setObjectName("cancleButton")
        self.okButton = QtWidgets.QPushButton(QDialog)
        self.okButton.setGeometry(QtCore.QRect(150, 120, 81, 32))
    ...
    def addConfirm(self):
        if len(self.comboBox.currentText()) == 0 or len(self.name.text()) == 0:
