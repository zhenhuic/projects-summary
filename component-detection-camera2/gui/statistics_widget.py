...
# Form implementation generated from reading ui file 'E:\Lab417\xio-intrusion-detection\configs\statistics_widget.ui'
#
...
"color: rgb(85, 255, 255);")
        ...
        self.startDateEdit.setMinimumSize(QtCore.QSize(0, 30))
        self.startDateEdit.setStyleSheet("background-color: rgb(35, 35, 35);\n"
"font: 12pt \"宋体\";\n"
"color: rgb(85, 255, 255);")
...
"color: rgb(85, 255, 255);")
        ...
        self.endDateEdit.setMinimumSize(QtCore.QSize(0, 30))
        self.endDateEdit.setStyleSheet("background-color: rgb(35, 35, 35);\n"
"font: 12pt \"宋体\";\n"
"color: rgb(85, 255, 255);")
...
"color: rgb(255, 255, 255);")
        ...
        self.sendEmailReport = QtWidgets.QAction(StatisticsWindow)
        self.sendEmailReport.setObjectName("sendEmailReport")
        ...
        self.notificationMenu.addAction(self.sendEmailReport)
    ...
    def retranslateUi(self, StatisticsWindow):
        ...
        self.titleLabel.setText(_translate("StatisticsWindow", "配件投放情况统计与可视化"))
        self.label_9.setText(_translate("StatisticsWindow", "生产线："))
        self.productionLineComboBox.setItemText(0, _translate("StatisticsWindow", "line_1"))
        self.label.setText(_translate("StatisticsWindow", "开始日期："))
        self.label_3.setText(_translate("StatisticsWindow", "截止日期："))
        ...
        self.notificationMenu.setTitle(_translate("StatisticsWindow", "通知"))
        ...
        self.sendEmailReport.setText(_translate("StatisticsWindow", "发送邮件报告"))
