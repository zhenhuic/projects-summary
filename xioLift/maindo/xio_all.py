...
class XioAll(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.op20_work_background = cv2.imread('images/173d.jpg')
        self.op20_work_background = cv2.resize(self.op20_work_background, (1280, 720))
        self.M5000_fix_backgrond = cv2.imread('images/173f.png')
        self.M5000_fix_backgrond = cv2.resize(self.M5000_fix_backgrond, (1280, 720))
        self.op20_night_background = cv2.imread('images/173n.png')
    ...
    def video_receive_local(self, cam1='videos/173_10.mp4', cam2='./videos/n171.mp4', time_flag=True):
        '''该方法用来接收本地视频
        :param cam1: 左摄像头数据源
        :param cam2: 右摄像头数据源
