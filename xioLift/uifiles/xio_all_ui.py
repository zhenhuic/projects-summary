...
# Form implementation generated from reading ui file 'xio_all_ui_mail_select_houban.ui'
#
...
"color:rgb(255, 255, 255);"))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "   生产操作行为的自动识别（厚板）", None))
        ...
        self.label_3.setText(_translate("Form", "   生产操作行为的自动识别(厚板)", None))
